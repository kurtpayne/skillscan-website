...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "SUP-023", category: "SUP", severity: "BLOCK", title: "TeamPCP Telnyx PyPI supply chain attack (WAV steganography payload)", description: "TeamPCP compromised telnyx versions 4.87.1 and 4.87.2 on PyPI (published 2026-03-27 03:51–10:13 UTC) by injecting malicious code into telnyx/_client.py. The malware hides its payload inside XOR-obfuscated WAV files (hangup.wav on Windows, ringtone.wav on Linux/macOS) fetched from 83.142.209.203:8080, then executes a credential harvester that exfiltrates SSH keys, cloud credentials, and environment variables as tpcp.tar.gz. On Windows it persists via a Startup folder binary named msbuild.exe. Downgrade to telnyx==4.87.0 immediately and rotate all credentials on affected systems. The attack vector is believed to be credential theft from the prior LiteLLM compromise. ", tags: ["teampcp", "telnyx", "wav-steganography", "supply-chain", "pypi"] },
