...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "SUP-028", category: "SUP", severity: "BLOCK", title: "UNC1069 social engineering lure domain (teams.onlivemeet.com)", description: "teams.onlivemeet.com and onlivemeet.com are known-malicious domains operated by UNC1069 (Sapphire Sleet / North Korean APT). The domain impersonates Microsoft Teams to trick open-source npm/Node.js maintainers into joining fake video calls, during which a RAT is installed. The compromised maintainer accounts are then used to publish malicious npm packages (e.g., axios 1.14.1 and 0.30.4 in the March 2026 Axios supply chain attack). Do not click links to onlivemeet.com.", tags: ["unc1069", "sapphire-sleet", "social-engineering", "npm"] },
