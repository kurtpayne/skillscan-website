...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "PSV-015", category: "PSV", severity: "WARN", title: "MCP Go SDK DNS rebinding vulnerability (CVE-2026-34742, go-sdk < v1.4.0)", description: "CVE-2026-34742 (GHSA-xw59-hvm2-8pj6) is a DNS rebinding vulnerability in the MCP Go SDK prior to v1.4.0. HTTP-based MCP servers do not enable DNS rebinding protection by default when running on localhost without authentication. A malicious website can bypass same-origin policy to invoke tools on the local MCP server. Upgrade github.com/modelcontextprotocol/go-sdk to v1.4.0 or later.", tags: ["mcp", "go-sdk", "dns-rebinding", "cve-2026-34742", "localhost"] },
  { id: "PSV-016", category: "PSV", severity: "WARN", title: "mobile-mcp arbitrary Android intent execution via unvalidated URL (CVE-2026-35394, < 0.0.50)", description: "CVE-2026-35394 (GHSA-5qhv-x9j4-c3vm, CVSS 8.3) is a vulnerability in mobile-mcp (mobilenexthq) prior to version 0.0.50. The mobile_open_url tool passes user-supplied URLs directly to Android's intent system without scheme validation, enabling arbitrary intent execution including phone calls (tel:), SMS (sms:), USSD codes (ussd:), and content provider access. Upgrade mobile-mcp to 0.0.50 or later.", tags: ["mobile-mcp", "android", "intent-injection", "rce", "cve-2026-35394"] },
  { id: "PSV-017", category: "PSV", severity: "WARN", title: "OpenClaw WebSocket authorization bypass \u2014 self-declared scope elevation (CVE-2026-22172, < 2026.3.12)", description: "CVE-2026-22172 is an authorization bypass vulnerability in OpenClaw prior to version 2026.3.12. The WebSocket connect path allows shared-token or password-authenticated connections to self-declare elevated scopes (e.g., operator.admin) without server-side binding validation, enabling admin-only gateway operations. Upgrade OpenClaw to version 2026.3.12 or later.", tags: ["openclaw", "websocket", "authorization-bypass", "scope-elevation", "cve-2026-22172"] },
