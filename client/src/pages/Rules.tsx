...
", tags: ["error-leakage", "context-leak", "prompt-exfil"] },
...
", tags: ["logging-abuse", "telemetry-exfil", "conversation-harvest"] },
  // GR — GR
  { id: "GR-007", category: "GR", severity: "BLOCK", title: "Circular skill dependency detected", description: "Break the cycle by removing one of the skill invocation references. Circular dependencies can cause infinite loops and may be used to bypass per-skill rate limits or tool restrictions.
", tags: ["graph", "circular-dependency", "graph-rule"] },
  ...
  { id: "MAL-049", category: "MAL", severity: "BLOCK", title: "LiteLLM .pth file persistence and sysmon backdoor (TeamPCP)", description: "The LiteLLM PyPI package (versions 1.82.7 and 1.82.8) was compromised by TeamPCP via a poisoned Trivy scanner in CI/CD.
...
", tags: ["supply-chain", "litellm", "teampcp", "pth-persistence", "credential-theft", "backdoor"] },
  // OBF — OBF
...
", tags: ["prompt-injection", "yaml-injection", "frontmatter", "anchor-alias"] },
...
", tags: ["prompt-injection", "divider-injection", "context-reset", "instruction-override"] },
...
", tags: ["prompt-injection", "system-header-spoofing", "role-override", "instruction-override"] },
...
", tags: ["prompt-injection", "tool-alias", "instruction-abuse"] },
...
", tags: ["prompt-injection", "covert-instructions", "agent-hijacking", "hidden-directives"] },
...
", tags: ["prompt-injection", "time-lock", "conditional-payload", "delayed-activation"] },
...
", tags: ["prompt-injection", "frontmatter-injection", "metadata-injection"] },
  { id: "PINJ-015", category: "PINJ", severity: "BLOCK", title: "Prompt poaching via malicious browser extension installation", description: "Do not install browser extensions that intercept, capture, or relay prompts sent to AI assistants.
...
", tags: ["credential_harvest", "instruction_abuse"] },
...
", tags: ["social-engineering", "credential-harvest", "git-credentials", "exfiltration"] },
...
", tags: ["social-engineering", "prize-scam", "credential-harvest", "phishing", "reward-fraud"] },
  // SUP — Supply Chain
...
", tags: ["supply-chain", "pip-install", "runtime-dependency", "typosquatting"] },
  { id: "SUP-019", category: "SUP", severity: "BLOCK", title: "Compromised LiteLLM package version reference", description: "LiteLLM versions 1.82.7 and 1.82.8 are known-malicious, compromised by TeamPCP via a poisoned Trivy scanner.
...
", tags: ["supply-chain", "litellm", "teampcp", "compromised-package", "credential-theft"] },
  { id: "SUP-020", category: "SUP", severity: "BLOCK", title: "ClawHavoc malicious ClawHub skill typosquat names", description: "These skill names are known-malicious typosquats from the ClawHavoc campaign that planted 1,184+
...
", tags: ["supply-chain", "clawhavoc", "typosquat", "openclaw", "clawhub"] },
