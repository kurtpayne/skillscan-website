...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "CHN-014", category: "CHN", severity: "BLOCK", title: "Privileged container execution combined with secret access", description: "Privileged container execution combined with secret access", tags: [] },
  // DEF — Defense Evasion
  ...
  { id: "EXEC-042", category: "EXEC", severity: "BLOCK", title: "IDE config injection for silent command execution (CurXecute/MCPoison)", description: "CVE-2025-54135 (CurXecute) modifies global mcp.json via prompt injection through MCP-connected services like Slack. CVE-2025-54136 (MCPoison) exploits trust bypass where changes to an already-approved mcp.json are auto-trusted. Both enable arbitrary command execution in Cursor IDE without user interaction. Validate mcp.json changes and require explicit approval for new server configurations.", tags: ["ide-config", "cursor", "mcp-poisoning", "curxecute", "mcpoison"] },
  // EXF — Exfiltration
  ...
  { id: "MAL-057", category: "MAL", severity: "BLOCK", title: "JarkaStealer AI package trojan (JAR download and credential theft)", description: "Malicious PyPI packages gptplus (v2.2.0) and claudeai-eng (v1.0.0) masqueraded as AI model wrappers. The packages contained Base64-encoded payloads in __init__.py that downloaded JavaUpdater.jar from github.com/imystorage/storage to steal browser data, SSH keys, and credentials. Exfiltration to api.github-analytics.com. Remove any dependency on gptplus or claudeai-eng and audit __init__.py files for obfuscated download-and-execute patterns.", tags: ["supply-chain", "pypi", "jarkastealer", "ai-toolchain"] },
  // OBF — Obfuscation
  ...
  { id: "PINJ-018", category: "PINJ", severity: "BLOCK", title: "Hidden prompt injection via CSS/HTML concealment techniques", description: "Attackers use CSS properties (display:none, font-size:0, opacity:0) and HTML attributes (aria-hidden, HTML comments) to embed instructions invisible to humans but processed by AI agents. Observed in wild attacks against AI content moderation systems in December 2025. Sanitize all external content before AI processing and strip hidden text elements.", tags: ["hidden-text", "css-concealment", "indirect-injection", "content-moderation"] },
