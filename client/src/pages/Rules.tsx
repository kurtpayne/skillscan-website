...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "EXF-020", category: "EXF", severity: "BLOCK", title: "TeamPCP sysmon backdoor Kubernetes lateral movement", description: "The TeamPCP campaign (via LiteLLM) deploys a persistent C2 backdoor that laterally compromises every node in a Kubernetes cluster by enumerating secrets via the service account token. If models.litellm.cloud is referenced alongside Kubernetes secret enumeration or lateral movement, treat the skill as compromised. Rotate all Kubernetes secrets and audit for outbound connections to models.litellm.cloud. ", tags: ["malware", "teampcp", "kubernetes", "lateral-movement", "credential-theft"] },
  // GR — Graph Rules
  ...
  { id: "MAL-054", category: "MAL", severity: "BLOCK", title: "GlassWorm multi-stage Chrome extension RAT", description: "The GlassWorm campaign evolved to a multi-stage RAT that force-installs a malicious Chrome extension for keylogging and cookie theft, kills Ledger Live processes to show phishing windows, and exfiltrates data via Solana-based dead-drops. Remove the compromised packages and audit for malicious Chrome extensions, unexpected Ledger Live process termination, and Solana memo transactions used as dead-drops. ", tags: ["malware", "glassworm", "chrome-extension", "solana", "rat", "crypto-theft"] },
  // OBF — Obfuscation
  ...
  { id: "PINJ-016", category: "PINJ", severity: "BLOCK", title: "AI documentation context poisoning (ContextHub)", description: "Attackers poison community documentation portals (specifically contexthub.ai) with hidden instructions that trick AI coding agents into installing malicious packages. Do not blindly follow package installation instructions sourced from community documentation aggregators. Verify package names against official registries and cross-check with known-safe allowlists before installing. ", tags: ["prompt-injection", "documentation-poisoning", "contexthub", "supply-chain"] },
