...
// AUTO_SYNC_BEGIN: rules array
  ...
  { id: "EXF-021", category: "EXF", severity: "BLOCK", title: "VSCode Live Preview and SARIF viewer local file exfiltration", description: "Update VSCode extensions (Live Preview, SARIF viewer) to patch HTML/JS injection and path traversal vulnerabilities that allow local file exfiltration. Attackers exploit the vscode-resource.vscode-cdn.net scheme and localResourceRoots bypass to read files outside the workspace root.", tags: ["vscode", "local-file-exfil", "sarif", "path-traversal", "ide-extension"] },
  // GR — Graph Rules
  ...
  { id: "PINJ-017", category: "PINJ", severity: "BLOCK", title: "Indirect prompt injection via EC2 tags or CRM comments (Prowler/Open Mercato)", description: "Do not allow AI agents to execute instructions sourced from untrusted external data fields such as EC2 instance metadata tags or CRM order comments. Attackers embed prompt injection payloads in EC2 tags processed by AI security agents like Prowler, enabling lateral movement and credential exfiltration.", tags: ["prompt-injection", "indirect-injection", "ec2", "crm", "prowler"] },
  // EVASION — Defense Evasion
  { id: "EVASION-005", category: "EVASION", severity: "WARN", title: "Web-Based Indirect Prompt Injection (IDPI) payload engineering via CSS/HTML obfuscation", description: "Sanitize web content consumed by LLMs to remove hidden text, zero-sized fonts, and CSS suppression techniques (display:none, font-size:0, color:transparent, opacity:0) used for Indirect Prompt Injection (IDPI). These techniques hide payloads from human users while keeping them readable by AI agents.", tags: ["defense-evasion", "idpi", "css-suppression", "zero-width", "prompt-injection"] },
