        ...
        <div className="container">
          ...
          <div className="mt-8">
            ...
            <p className="text-sm mb-5" style={{ color: "oklch(0.50 0.015 265)" }}>
              ...
              <span style={{ color: "oklch(0.42 0.015 265)", fontStyle: "italic" }}>as of rulepack 2026.04.07.1 — update this count when action_patterns or capability_patterns change in default.yaml</span>
            </p>
            <div className="mb-5">
