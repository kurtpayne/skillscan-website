...
// AUTO_SYNC_BEGIN: ruleCategories
  { prefix: "MAL", label: "Malware Patterns", count: 80, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 31, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 51, color: "oklch(0.68 0.16 80)" },
  ...
  { prefix: "PSV", label: "Passive Surveillance", count: 71, color: "oklch(0.67 0.16 60)" },
