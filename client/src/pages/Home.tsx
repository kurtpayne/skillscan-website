...
const ruleCategories = [
  { prefix: "MAL", label: "Malware Patterns", count: 34, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 4, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 5, color: "oklch(0.68 0.16 80)" },
];
