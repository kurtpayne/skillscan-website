...
// AUTO_SYNC_BEGIN: ruleCategories
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 27, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 38, color: "oklch(0.68 0.16 80)" },
  ...
  { prefix: "PSV", label: "Passive Surveillance", count: 32, color: "oklch(0.67 0.16 60)" },
