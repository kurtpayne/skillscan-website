...
// AUTO_SYNC_BEGIN: ruleCategories
  { prefix: "MAL", label: "Malware Patterns", count: 81, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "SUP", label: "Supply Chain", count: 52, color: "oklch(0.68 0.16 80)" },
  ...
  { prefix: "PSV", label: "Passive Surveillance", count: 77, color: "oklch(0.67 0.16 60)" },
