...
// AUTO_SYNC_BEGIN: ruleCategories
  { prefix: "MAL", label: "Malware Patterns", count: 62, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 19, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 30, color: "oklch(0.68 0.16 80)" },
  ...
  { prefix: "PSV", label: "Passive Surveillance", count: 9, color: "oklch(0.67 0.16 60)" },
...
export default function Home() {
  ...
  const [ruleCount, setRuleCount] = useState(177);
