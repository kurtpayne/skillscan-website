...
// AUTO_SYNC_BEGIN: ruleCategories
  { prefix: "MAL", label: "Malware Patterns", count: 67, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 22, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 35, color: "oklch(0.68 0.16 80)" },
  { prefix: "SE", label: "Social Engineering", count: 4, color: "oklch(0.62 0.20 340)" },
  ...
  { prefix: "PSV", label: "Passive Surveillance", count: 19, color: "oklch(0.67 0.16 60)" },
        ...
        <div className="container py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { value: "Beta", label: "ML Model" },
              { value: "v11 soon", label: "Metrics in revision" },
