...
// AUTO_SYNC_BEGIN: ruleCategories
  { prefix: "MAL", label: "Malware Patterns", count: 63, color: "oklch(0.65 0.22 25)" },
  ...
  { prefix: "PINJ", label: "Prompt/Pipeline Injection", count: 20, color: "oklch(0.55 0.24 280)" },
  { prefix: "SUP", label: "Supply Chain", count: 31, color: "oklch(0.68 0.16 80)" },
