...
const PROVIDERS = [
  { id: "openrouter", label: "OpenRouter", badge: "200+ models", defaultModel: "anthropic/claude-3.7-sonnet", defaultJudge: "anthropic/claude-sonnet-4-6", envKey: "OPENROUTER_API_KEY" },
